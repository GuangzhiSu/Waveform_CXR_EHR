#!/usr/bin/env python3
"""Regression: last-pool must use final anchor slot, not padding between ECG and anchor."""
...
for _p in (_EXP, _PROJECT_ROOT / "CXREncoderTransformer", _PROJECT_ROOT):
...
def main() -> int:
    ...
    # After collate + anchor append: [ECG valid, pad..., anchor valid]
    mask = torch.tensor(
        [
