...
python legacy/encoder_transformers/ECGEncoderTransformer/validate_data.py

# Diagnostics
python legacy/encoder_transformers/ECGEncoderTransformer/diagnose_masks.py
python legacy/encoder_transformers/ECGEncoderTransformer/debug_nan_loss.py --max_batches 300
python legacy/encoder_transformers/ECGEncoderTransformer/diagnose_collapse.py --max_samples 2000 --epochs 5
python legacy/encoder_transformers/ECGEncoderTransformer/verify_collapse_fix.py --max_samples 2000 --mini_steps 120

# Slurm GPU
sbatch legacy/encoder_transformers/ECGEncoderTransformer/run_train.sh

# Debug subset (recommended stable hyperparams)
sbatch legacy/encoder_transformers/ECGEncoderTransformer/run_train.sh --max_samples 5000 --epochs 10
```
