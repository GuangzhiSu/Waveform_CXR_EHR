...
# (artifacts/pylibs/, holds health_multimodal + gdown) and the vendored ECG-R1 repo.
...
export PYTHONUSERBASE="${_SCRIPT_DIR}/artifacts/pylibs"
export PATH="${PYTHONUSERBASE}/bin:${PATH}"
_PY_SP="${PYTHONUSERBASE}/lib/python3.9/site-packages"

export PYTHONPATH="${_SCRIPT_DIR}:${_PY_SP}:${_SCRIPT_DIR}/external/ECG-R1:${_PROJECT_DIR}:${PYTHONPATH:-}"
